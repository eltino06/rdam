      ...
      <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '40px' }}>
          ...
          <div style={{ display: 'flex', gap: '12px' }}>
            ...
            <div style={{ position: 'relative' }}>
              ...
              <div style={{
                ...
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="rgba(59,130,246,0.6)" strokeWidth="2">
        ...
        <div style={{
          ...
          {[
            ...
            { label: 'Administradores', value: usuarios.filter(u => u.rol === 'ADMIN').length, color: '#a78bfa' },
            { label: 'Operadores', value: usuarios.filter(u => u.rol === 'OPERADOR').length, color: '#34d399' },
            { label: 'Ciudadanos', value: usuarios.filter(u => u.tipo === 'CIUDADANO').length, color: '#fbbf24' },
            { label: 'Activos', value: usuarios.filter(u => u.activo !== false).length, color: '#10b981' },
          ].map((stat) => (
            <div key={stat.label} style={{
              ...
              <div style={{
                ...
                height: '3px', background: stat.color,
              }}></div>
              <p style={{ margin: '0 0 6px 0', color: 'rgba(255,255,255,0.5)', fontSize: '12px', fontWeight: '600', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                {stat.label}
              </p>
              ...
              <tbody>
                {usuariosFiltrados.map((u) => (
                  ...
                  >
                    ...
                    <td style={{ padding: '20px 24px', color: 'rgba(255,255,255,0.7)', fontSize: '14px' }}>
                      {u.email}
                    </td>
                    <td style={{ padding: '20px 24px' }}>
                      <span style={{
                        ...
                        fontSize: '12px',
                        fontWeight: '700',
                        background: u.tipo === 'CIUDADANO' ? 'rgba(251,191,36,0.15)' : 'rgba(59,130,246,0.15)',
                      ...
                      <div style={{ display: 'flex', gap: '8px' }}>
                        ...
                        {u.id !== user?.id && (
                          <button
                            ...
                            style={{
                              padding: '7px 14px',
                              background: u.activo !== false ? 'rgba(239,68,68,0.1)' : 'rgba(16,185,129,0.1)',
                            ...
                            onMouseEnter={(e) => {
                              e.currentTarget.style.background = u.activo !== false ? 'rgba(239,68,68,0.2)' : 'rgba(16,185,129,0.2)';
                            }}
                            onMouseLeave={(e) => {
                              e.currentTarget.style.background = u.activo !== false ? 'rgba(239,68,68,0.1)' : 'rgba(16,185,129,0.1)';
                            }}
                          >
        ...
        <div style={{
          ...
          <div style={{
            ...
            <p style={{ margin: '0 0 28px 0', color: 'rgba(255,255,255,0.5)', fontSize: '14px' }}>
              {editando ? 'Modifica los datos del usuario' : 'Completa los datos para crear un nuevo usuario'}
            </p>

            <form onSubmit={handleSubmit}>
              {/* Nombre */}
              <div style={{ marginBottom: '20px' }}>
                <label style={{ display: 'block', color: 'rgba(255,255,255,0.9)', fontSize: '13px', fontWeight: '600', marginBottom: '8px' }}>
                  Nombre Completo *
                </label>
                <input
                  type="text"
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', marginBottom: '28px' }}>
                <div>
                  ...
                  >
                    <option value="INTERNO" style={{ background: '#1e293b' }}>INTERNO</option>
                    <option value="CIUDADANO" style={{ background: '#1e293b' }}>CIUDADANO</option>
                  </select>
                </div>
                <div>
                  <label style={{ display: 'block', color: 'rgba(255,255,255,0.9)', fontSize: '13px', fontWeight: '600', marginBottom: '8px' }}>
                  ...
                  <select
                    ...
                    onBlur={(e) => { e.target.style.borderColor = 'rgba(59,130,246,0.2)'; }}
                  >
                    <option value="OPERADOR" style={{ background: '#1e293b' }}>OPERADOR</option>
