        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start' }}>
              <div>
                <p style={{ margin: '0 0 8px 0', color: 'rgba(255, 255, 255, 0.6)', fontSize: '13px', fontWeight: '600', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                  Solicitudes Activas
                </p>
        ...
        <div style={{
          ...
          {dashboard?.recientes && dashboard.recientes.length > 0 ? (
              ...
              <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                ...
                <tbody>
                  {dashboard.recientes.map((solicitud: any) => (
                    ...
                    >
                      <td style={{ padding: '20px 32px', fontWeight: '700', color: '#60a5fa', fontSize: '14px' }}>
                      ...
                      <td style={{ padding: '20px 32px', color: 'rgba(255, 255, 255, 0.6)', fontSize: '14px' }}>
            ...
            <div style={{ padding: '60px', textAlign: 'center' }}>
              ...
              <h3 style={{ color: 'rgba(255, 255, 255, 0.6)', marginBottom: '12px', fontSize: '18px' }}>
                No hay solicitudes
              </h3>
